...
#print(p)
'''
plt.plot(p,label="XLB Price",linestyle='-')
plt.title('XLB Price ')
plt.xlabel('Time')
plt.ylabel('Price in $')
plt.legend()
...
for i in range(start_index,len(test_set_scaled)):
...
plt.plot(test_set[start_index:, :],label="Actual Price",linestyle='--') ### from observation 60 to 226 till 28 Nov 2024
